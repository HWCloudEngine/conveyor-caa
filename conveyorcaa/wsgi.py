...
from conveyorcaa.common import utils
from conveyorcaa import exception
from conveyorcaa.i18n import _

wsgi_opts = [
    cfg.StrOpt('api_paste_config',
               default="conveyorcaa-paste.ini",
               help='File name for the paste.deploy conf for conveyorcaa-api'),
...
class Server(object):
    ...
    def __init__(self, name, app, host='0.0.0.0', port=0, pool_size=None,
        ...
        :returns: None
        :raises: conveyorcaa.exception.InvalidInput
        """
        ...
        self._logger = logging.getLogger(
            "conveyorcaa.%s.wsgi.server" % self.name)
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'conveyorcaa.best_content_type' not in self.environ:
            ...
            self.environ['conveyorcaa.best_content_type'] = (content_type or
                                                            'application/json')

        return self.environ['conveyorcaa.best_content_type']
...
class BaseApplication(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = conveyorcaa.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import conveyorcaa.api.fancy_api
...
class Middleware(BaseApplication):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = conveyorcaa.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import conveyorcaa.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `conveyorcaa.exception.PasteAppNotFound`
...
class Application(BaseApplication):
    ...
    def __call__(self, req):
        ...
        except exception.ConveyorCaaException as e:
            LOG.exception(e)

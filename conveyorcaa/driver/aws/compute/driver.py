...
from conveyorcaa.driver import utils
from conveyorcaa.driver.aws.compute import event as virtevent
from conveyorcaa.i18n import _, _LE, _LI
...
class ComputeDriver(object):
    ...
    compute.virt layer, instances do not have human-readable names at all --
    such things are only known higher up the stack.
    ...
    Some methods here take an instance of compute.compute.service.Instance.
    This is the data structure used by compute.compute to store details
    regarding an instance, and pass them into this layer.  This layer is
    responsible for translating that generic data structure into terms that
    are specific to the virtualization platform.
    ...
    def finish_migration(self, context, migration, instance, disk_info,
        ...
        :param instance: compute.objects.instance.Instance be migrated/resized
        :param disk_info: the newly transferred disk information
        :param network_info:
           :py:meth:`~network.manager.NetworkManager.get_instance_nw_info`
        :param compute.objects.ImageMeta image_meta:
            The metadata of the image of the instance.
    ...
    def finish_revert_migration(self, context, instance, network_info,
        ...
        :param instance: objects.instance.Instance being migrated/resized
        :param network_info:
           :py:meth:`~compute.network.manager.NetworkManager.get_instance_nw_info`
        :param block_device_info: instance volume block device info
        :param power_on: True if the instance should be powered on, False
    ...
    def provider_clients_cleanup(self, context, project_mapper=None):
